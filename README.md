...
I'm a **full-stack developer** who genuinely enjoys every layer of the stack. From building smooth, responsive UIs with **React.js** to designing REST APIs, architecting databases, and reasoning about how systems scale — I care about all of it equally.

I don't specialize in just one area by choice. I believe the best developers understand the entire product — how the frontend talks to the backend, how the backend talks to the database, and how all of it holds together under real load. **Versatility backed by strong fundamentals** is what I'm building toward.

I'm constantly working on projects, solving DSA problems, reading codebases, and finding new problems worth solving. Always building. Always learning. Always shipping.
...
const janakiram = {
  ...
  name      :  "Janakiram Baddula",
  role      :  "Full Stack Developer",
  location  :  "India 🇮🇳  (IST, UTC+5:30)",

  contact   : {
    email    :  "baddulabablu05@gmail.com",
    phone    :  "+91 7989462265",
    linkedin :  "baddula-janakiram-7b436b321",
    github   :  "JANAKIRAM218"
  },
  ...
  interests :  ["Full Stack Dev", "System Design", "DSA", "Open Source"],
  openTo    :  ["Roles", "Internships", "Collaborations", "Open Source"],

  motto     :  "Every layer of the stack is worth mastering 🔥"
...
> 🧩 **HackHub** — Your ultimate developer playground! Practice coding challenges, earn XP & badges, participate in weekly competitions, and showcase your projects in a vibrant hacker-themed community. &nbsp;[![Live Demo](https://img.shields.io/badge/Live_Demo-1a0a2e?style=flat-square&logo=vercel&logoColor=A855F7)](https://hack-hub-e4fa686c.base44.app/)
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=JANAKIRAM218&bg_color=1a0a2e&color=A855F7&line=7C3AED&point=DB2777&area=true&hide_border=true&area_color=7C3AED&radius=12"/>
...
> *" The best engineers aren't those who know the most —*
> *they're the ones who stay curious the longest.*
> *Understand deeply, build intentionally, ship consistently.*
> *Your code is a reflection of how you think. Make it worth reading. "*

<br/>

![](https://img.shields.io/badge/Full_Stack_by_Choice-1a0a2e?style=for-the-badge&labelColor=7C3AED)
&nbsp;
![](https://img.shields.io/badge/Build_It_Right-1a0a2e?style=for-the-badge&labelColor=DB2777)
&nbsp;
![](https://img.shields.io/badge/Always_Shipping-1a0a2e?style=for-the-badge&labelColor=7C3AED)
&nbsp;
![](https://img.shields.io/badge/Stay_Curious-1a0a2e?style=for-the-badge&labelColor=DB2777)
...
<div align="center">
<sub>
  <strong>⚡ JANAKIRAM218</strong> &nbsp;·&nbsp; Full Stack Developer &nbsp;·&nbsp; India 🇮🇳 &nbsp;·&nbsp; 2025
  <br/>
